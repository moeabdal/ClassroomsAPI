...
from classes_api.views import ClassroomListAPI, ClassroomDetailAPI, ClassroomCreateAPI, RetrieveAPIView, ClassroomDeleteAPI, RegisterAPI, ClassroomUpdateAPI
